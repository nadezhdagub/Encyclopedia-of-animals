...
public class Information_downsizingTest extends TestCase {
    ...
    public void testAddOnButton() {
        ...
        Information_downsizing information = new Information_downsizing();
        TestUrl testUrl = new TestUrl();

        testUrl.setUrl(url);
        ActivityScenario<Information_downsizing> scenario =
                ActivityScenario.launch(Information_downsizing.class);
