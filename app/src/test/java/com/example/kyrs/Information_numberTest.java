...
public class Information_numberTest extends TestCase {
    ...
    public void testAddOnButton() {
        ...
        Information_number information = new Information_number();
        TestUrl testUrl = new TestUrl();

        testUrl.setUrl(url);
        ActivityScenario<Information_number> scenario =
                ActivityScenario.launch(Information_number.class);
