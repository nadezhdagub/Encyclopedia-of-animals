...
public class Information_area  extends AppCompatActivity {
    public static final String EXTRA_MESSAGE = "";
    public static int i;
    public TextView text;
    public static String SERVER_URLB = "http://192.168.56.1:8080/animal/infb_area";
    public static String SERVER_URLV = "http://192.168.56.1:8080/animal/infv_area";
